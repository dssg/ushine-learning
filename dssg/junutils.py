...
uchaguziPath = os.path.abspath('.') + '/data/processed/uchaguzi/uchaguzi-message_with_category_list.csv'
uchaguziJsonPath = os.path.abspath('.') + '/data/processed/uchaguzi_new.json'
uchaguziCategoryJsonPath = os.path.abspath('.') + '/data/processed/uchaguzi_new_categories.json'
